...
## Project Structure
    ...
    ├── ba_team_feature_prd_37650  # Django project configurations
...
1. Clone this repo and `cd ba_team_feature_prd_37650`
...
2. Clone this repo and `cd ba_team_feature_prd_37650`
